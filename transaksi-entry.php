...
<body>
	<div class="sidebar">
		...
		<ul class="nav-links">
			...
			<li>
				<a href="jenis.php">
					<i class="bx bx-box"></i>
					<span class="links_name">jenisbuah</span>
				</a>
			</li>
			<li>
	...
	<section class="home-section">
		...
		<div class="home-content">
			...
			<form action="transaksi-proses.php" method="post" enctype="multipart/form-data">
				<label for="nama">Nama</label>
				<input class="input" type="text" name="nama" id="nama" placeholder="Nama" />
                    <label for="jenisbuah">jenisbuah </label>
                    <input class="input" type="texy" name="jenisbuah" id="jenisbuah" placeholder="jenisbuah" />
